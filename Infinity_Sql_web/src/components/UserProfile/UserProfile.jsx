...
const Users = () => {
  ...
  const isUserFollowed = (userId) =>
    user.following.some((follow) => follow.id === userId);
                        ...
                        >
                          <div className="content_box user_name">
                            ...
                            {user.userName === reqUser.userName ? (
                              ...
                              <button
                                onClick={() => handleFollow(reqUser.id)}
                                className="userProfileFollowbtn"
                              >
                                {isAuthenticated && isUserFollowed(reqUser.id) ? (
                      ...
                      <div className="popup-content">
                        ...
                        {reqUser?.followers.length != 0
                          ? reqUser.followers.map((element) => {
                              const { id, userName, name, avatar } = element;
                              return (
                                <User
                                  key={id}
                                  userId={_d}
